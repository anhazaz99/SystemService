 ...
 * 
 * Hỗ trợ các loại receiver: student, lecturer, class, all_students
 */
class TaskReceiver extends Model
{
     ...
     */
    const ALLOWED_RECEIVER_TYPES = ['student', 'lecturer', 'class', 'all_students'];
    ...
    public function getActualStudents()
    {
        switch ($this->receiver_type) {
            ...
            case 'all_students':
                // Lấy tất cả students trong toàn trường nếu receiver_id = 0
